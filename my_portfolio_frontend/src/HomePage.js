      ...
      <ul className="list-disc pl-5">
        ...
        <li className="text-base">
          ...
          <ul className="list-disc pl-5">
            ...
            <li className="text-base"><a className="text-blue-500" href="https://github.com/colelevy08/phase-1-group-project" target="_blank" rel="noopener noreferrer">Phase 1 - 8Group Project</a></li>
          </ul>
        </li>
        <li className="text-base">
